...
plot "../gen/data/Equity_values.dat" using 1:4 title "Liabilities", '' using 1:5 title "Equity" 

set output "../gen/graph/EW_values.tex" 
plot "../gen/data/EW_values.dat" using 1:4 title "Liabilities", '' using 1:5 title "Equity" 

set output "../gen/graph/Debt_values.tex" 
plot "../gen/data/Debt_values.dat" using 1:4 title "Liabilities", '' using 1:5 title "Equity" 

set output "../gen/graph/VarianceMin_values.tex" 
plot "../gen/data/VarianceMin_values.dat" using 1:4 title "Liabilities", '' using 1:5 title "Equity" 
...
plot "../gen/data/daily_ret.dat" using 1:(percent($4)) title "Equity", '' using 1:(percent($5)) title "EW", '' using 1:(percent($6)) title "Debt", '' using 1:(percent($7)) title "VarianceMin" 
...
plot "../gen/data/hpr_ret.dat" using 1:(percent($4)) title "Equity", '' using 1:(percent($5)) title "EW", '' using 1:(percent($6)) title "Debt", '' using 1:(percent($7)) title "VarianceMin" 
# ======================
# Drawdown              
# ======================
...
plot "../gen/data/drawdown_ret.dat" using 1:(percent($4)) title "Equity", '' using 1:(percent($5)) title "EW", '' using 1:(percent($6)) title "Debt", '' using 1:(percent($7)) title "VarianceMin" 
# ======================
# Volatility            
# ======================
...
plot "../gen/data/volatility_ret.dat" using 1:(percent($4)) title "Equity", '' using 1:(percent($5)) title "EW", '' using 1:(percent($6)) title "Debt", '' using 1:(percent($7)) title "VarianceMin" 
